...
class Command(BaseCommand):
    ...
    def handle(self, *args, **kwargs):
        logger.debug('Starting the populate_db command.')
        try:
            # Connect to MongoDB
            ...
            logger.debug('Dropped existing collections.')
            ...
            logger.debug('Created teams and added members.')
            ...
            logger.debug('Created leaderboard entries.')
